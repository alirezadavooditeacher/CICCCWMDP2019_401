...
//---- Problem 1 ----
func problem1(operators opt: Character, input1 number1: Int, input2 number2: Int){
    print("---- Problem 1 ----")
    switch opt {
    case "+":
...
problem1(operators: "/", input1: 30, input2: 6)
...
//---- Problem 3 ----
func problem3(inputNum1 inputNum1: Int, inputNum2 inputNum2: Int) -> Int?{
    print("\n---- Problem 3 ----")
    if inputNum1 < 0 {
        return nil
    }else if inputNum2 < 0 {
...
if let answer3 = problem3(inputNum1: 2, inputNum2: 6){
    print("The result is \(answer3).")
}
...
//---- Problem 6 ----
func problem6(swap1 swap1: inout Int, swap2 swap2: inout Int){
    print("\n\n---- Problem 6 ----")
...
//---- Problem 7 ----
func problem7(input7 input7: String) -> Int? {
    print("\n---- Problem 7 ----")
...
if let answer7 = problem7(input7: "BaBa") {
    print(answer7)
}
...
//---- Problem 11 ----
func problem11(inputArray11 inputArray11: [Int]){
    print("\n---- Problem 11 ----")
...
//---- Problem 13 ----
func problem13(inputArray13 inputArray13: [String]){
