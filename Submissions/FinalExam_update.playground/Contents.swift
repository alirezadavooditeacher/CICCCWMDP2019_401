...
class Rules{
    ...
    static func Display(Members:[Transformer]){
        ...
        if A_Winners.count > D_Winners.count{
            print("Winner team: Autobots (Win \(A_Winners.count)-battle) (Lose \(D_Winners.count)-battle)")
        }else if A_Winners.count == D_Winners.count{
            print("This turn is a tie")
        }else{
            print("Winner team: Decepticons (Win \(D_Winners.count)-battle) (Lose \(A_Winners.count)-battle)")
        }
        print("\nSurvivors-D:")
        for value in Dteam{
            print("\(value)")
